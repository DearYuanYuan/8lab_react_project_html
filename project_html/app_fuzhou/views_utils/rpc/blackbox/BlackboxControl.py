...
class Client(Iface):
    ...
    def say(self, msg, msg2):
        ...
        Parameters:
         ...
         - msg2
        """
        self.send_say(msg, msg2)
        return self.recv_say()

    def send_say(self, msg, msg2):
...
class Processor(Iface, TProcessor):
    ...
    def process_say(self, seqid, iprot, oprot):
        ...
        result = say_result()
        try:
            result.success = self._handler.say(args.msg, args.msg2)
            msg_type = TMessageType.REPLY
        except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
            raise
        except Exception as ex:
    ...
    def process_command(self, seqid, iprot, oprot):
        ...
        result = command_result()
        try:
            result.success = self._handler.command(args.msg)
            msg_type = TMessageType.REPLY
        except (TTransport.TTransportException, KeyboardInterrupt, SystemExit):
            raise
        except Exception as ex:
...
class say_args(object):
    ...
    thrift_spec = (
        ...
        (2, TType.STRING, 'msg2', 'UTF8', None, ),  # 2
    )

    def __init__(self, msg=None, msg2=None,):
        self.msg = msg
        self.msg2 = msg2
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.msg2 = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.msg2 is not None:
            oprot.writeFieldBegin('msg2', TType.STRING, 2)
            oprot.writeString(self.msg2.encode('utf-8') if sys.version_info[0] == 2 else self.msg2)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
