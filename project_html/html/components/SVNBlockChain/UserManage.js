...
export default class UserManage extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            username: '用户暂未填写',  　　　　　　//用户详情名字　
            status: '',                        //用户详情状态
            position: '用户暂未填写',            //用户详情职位
            phone: '用户暂未填写',               //用户详情电话
            email: '用户暂未填写',               //用户详情邮箱
            department: '用户暂未填写',          //用户详情部门
            host: [],                          //所有的可访问主机
                        ...
                        <div className='userDetailManage' >
                            ...
                            <div className="clearfix  userDetailManage-bottom">
                                ...
                                <div className="rootDic clearfix">
                                    ...
                                    <div className={this.state.is_super == 1 ? "allotRootDic" : "addRootDic"} onClick={() => this.showAllotRootPath()} >新建根目录</div>
                                    {this.state.is_super == 1 && <div className="addRootDic" onClick={() => this.DeleteRootPath()} >删除根目录</div>}
                                    {this.state.is_super == 0 && <div className="svnDeleteRootDic" onClick={() => this.cancelAuthorization()}>取消授权</div>}
                                    ...
                                    {!this.state.rootPathError && !this.state.rootPathLoading && this.state.hostList &&
                                        <div className='clearfix'>
                                            <table>
                                                <thead>
                                                    <tr>
                                                        <th><input type="checkbox" id="userManageSelAll" className="custom-checkbox" /><label className="manageCheckbox" htmlFor="userManageSelAll" onClick={(e) => this.AllCheckStatus(e)}></label>根目录标签</th>
                                                        <th>实际路径</th>
                                                        <th>分配时间</th>
                                                    </tr>
                                                </thead>
                                                ...
                                                <tbody>
                                                    ...
                                                    {this.state.hostList.map(function (list, index) {
                                                        return (
                                                            <tr key={index} >
