...
export default class FileManage extends React.Component {
     ...
     * option : 操作类型
     * */
    getProgressTime(progressId,option){
        var self = this;
        $.ajax({
            url: '/api/tamper_proof/query_task_progress/',
            type: 'POST',
            dataType: 'json',
            cache: false,
            data:{
     ...
     * progressId ： 任务id
     * */
    loopGetProgress(progressId,option){
        var self = this
        this.progressInterval =setInterval(function () {
            self.getProgressTime(progressId,option)
            // console.log(self.state.progressTime)
        },200)
    }
    ...
    backThisVersion(token,username,hostname,rootpath,tx_id){
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                //获取进度条
                self.loopGetProgress(data[0].result.task_id)
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if(data[0].status == 'FAILURE'){
                    ...
                    //获取进度条
                    self.loopGetProgress(data[0].result.task_id,'delete')
                    // self.setState({
                    //     DeleteFileBox:false,
                    //     tamperLoadingBox:false,
                    // })
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if(data[0].status == 'FAILURE'){
                        ...
                        self.loopGetProgress(data[0].result.task_id,'remove')
                    }
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if(data[0].status == 'FAILURE'){
                        ...
                        self.loopGetProgress(data[0].result.task_id,'reName')
                    }
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if(data[0].status == 'FAILURE'){
                    ...
                    self.loopGetProgress(data[0].result.task_id,'new')
                }
    ...
    */
    handleConformUpload(){
        ...
        //     return;
            ...
            var self = this;
            formData.append('service_type','web'),
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if(data[0].status == 'FAILURE'){
                        ...
                        self.loopGetProgress(data[0].result.task_id,'upLoad')
                    }
            ...
            <div>
                ...
                </div>
                {
                    ...
                    <RootFileVersionHistory
                        ...
                        errorMsg = {this.state.fileActionError}
