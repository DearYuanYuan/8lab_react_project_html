...
;(function ($, window, document) {
    ...
    Indicator.prototype = {
        ...
        init: function () {
            ...
            ctx.lineWidth = indOption.barWidth/2;
            ctx.beginPath();
    ...
    radialIndicator.defaults = {
        radius: 28, //inner radius of indicator
        barWidth: 4, //bar width
        barBgColor: '#A1A6AD', //unfilled bar color
        barColor: '#007AE1', //filled bar color , can be a range also having different colors on different value like {0 : "#ccc", 50 : '#333', 100: '#000'}
